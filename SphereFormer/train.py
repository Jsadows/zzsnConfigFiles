...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    elif args.data_name == 'cars':
        train_data = Cars(args.data_root, 
            voxel_size=args.voxel_size, 
            split='train', 
            return_ref=True, 
            label_mapping=args.label_mapping, 
    ...
    elif args.data_name == 'people':
        train_data = People(args.data_root, 
            voxel_size=args.voxel_size, 
            split='train', 
            return_ref=True, 
            label_mapping=args.label_mapping, 
    ...
    if args.data_name == 'nuscenes':
        ...
        val_data = Cars(data_path=args.data_root, 
            voxel_size=args.voxel_size, 
            split='val', 
            rotate_aug=args.use_tta, 
            flip_aug=args.use_tta, 
        ...
        val_data = People(data_path=args.data_root, 
            voxel_size=args.voxel_size, 
            split='val', 
            rotate_aug=args.use_tta, 
            flip_aug=args.use_tta, 
    ...
    for i, batch_data in enumerate(train_loader):  # (n, 3), (n, c), (n), (b)
       ...
       # print("xyz:", xyz)
        ...
        with torch.cuda.amp.autocast(enabled=use_amp):
            print(f"pos shape: {xyz.shape}")
           # print(f"classes: {args.classes}")
            #batch = batch.view(-1, 1).to(xyz.dtype)
