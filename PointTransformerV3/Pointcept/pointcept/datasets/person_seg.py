...
class PersonSegDataset(DefaultDataset):
    ...
    def get_data_list(self):
        ...
        for seq in seq_list:
            ...
            seq_files = sorted(os.listdir(os.path.join(seq_folder, "maps")))
            data_list += [
                os.path.join(seq_folder, "maps", file) for file in seq_files
            ]
        return data_list
    ...
    def get_data(self, idx):
        ...
        label_file = data_path.replace("maps", "labels")
